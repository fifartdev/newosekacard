...
export default function WalletButtons({ profileId, hasApplePass, hasGoogleWallet }: Props) {
  return (
    <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
      {hasApplePass ? (
        ...
        <DisabledButton label="Apple Wallet (unavailable)" />
      )}
      ...
      {hasGoogleWallet ? (
        ...
        <DisabledButton label="Google Wallet (unavailable)" />
      )}
    </div>
  )
}
